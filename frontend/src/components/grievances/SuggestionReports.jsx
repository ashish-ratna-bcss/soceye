    ...
    return (
        <div className="group">
            ...
            <button
                ...
                className="inline-flex items-center gap-1 text-[11px] font-bold text-violet-600 dark:text-violet-400 hover:text-violet-700 hover:underline mt-1 focus:outline-none"
            >
...
/* ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ */
/*   DETAIL VIEW – Executive Suggestion Case Dossier      */
/* ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ */
export const SuggestionReportDetailView = ({ report, onUpdate, onClose, onPrint }) => {
    ...
    const handleWhatsAppDirect = () => {
        ...
        const msg = [
            `💡 *SUGGESTION REPORT: ${r.unique_code || 'N/A'}*`,
            ``,
            ...
            ``,
            `_Shared via Telangana Police Grievance & Suggestion Portal_`
        ].join('\n');
    ...
    return (
        <div className="space-y-5 pb-6">
            ...
            <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-slate-900 via-purple-950 to-slate-900 border border-violet-800/40 p-5 text-white shadow-xl">
                <div className="absolute -right-10 -top-10 h-40 w-40 rounded-full bg-violet-500/10 blur-3xl pointer-events-none" />
                ...
                <div className="relative z-10 flex flex-wrap items-center justify-between gap-4">
                    <div className="flex items-center gap-4">
                        <div className="h-14 w-14 rounded-2xl bg-gradient-to-br from-violet-500/25 to-purple-600/35 border border-violet-400/40 flex items-center justify-center shadow-lg shadow-violet-950/50 backdrop-blur-sm">
                        ...
                        <div>
                            <div className="flex items-center gap-2">
                                ...
                                <Badge className={cn(
                                    ...
                                    {isClosed ? '✓ Action Taken' : '● Pending Review'}
                                </Badge>
                            </div>
                            ...
                            <div className="flex items-center gap-2.5 mt-1">
                                ...
                                <button
                                    ...
                                    className="p-1 rounded-md bg-white/10 hover:bg-white/20 text-violet-200 transition-colors"
                            ...
                            <p className="text-xs text-slate-300/80 mt-0.5 flex items-center gap-2">
                                ...
                                <span>•</span>
                                <span className="text-violet-300 font-medium">{fmtRelativeTime(r.post_date)}</span>
                            </p>
                        </div>
                    </div>
                        ...
                        {resolvedPdfUrl ? (
                            <div className="flex items-center gap-3 bg-white/10 backdrop-blur-md rounded-xl p-2 border border-white/15">
                                ...
                                <div className="flex flex-col pr-1">
                                    <span className="text-[10px] font-bold text-violet-200 uppercase tracking-wider">Official PDF</span>
                                    <a
                                        href={resolvedPdfUrl}
                                        target="_blank"
                            ...
                            <Button
                                ...
                                size="sm"
                                className="h-9 gap-1.5 bg-violet-600 hover:bg-violet-500 text-white font-bold text-xs rounded-xl shadow-md"
                            >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
                ...
                <div className="lg:col-span-2 rounded-2xl border border-border bg-card p-5 shadow-xs space-y-4">
                    <div className="flex items-center justify-between border-b border-border/80 pb-3">
                        <div className="flex items-center gap-2 font-bold text-sm text-foreground">
                            ...
                            <span>Suggestion Particulars</span>
                        </div>
                        <Badge variant="outline" className="text-xs font-bold border-violet-500/30 text-violet-600 dark:text-violet-400 bg-violet-500/10">
                            {r.category || 'General Suggestion'}
                        </Badge>
                    </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
                        ...
                        <div className="p-3 rounded-xl bg-muted/40 border border-border/60 space-y-1.5">
                            ...
                            <div className="flex items-center gap-2.5">
                                <div className="h-8 w-8 rounded-full bg-violet-500/15 border border-violet-500/30 flex items-center justify-center shrink-0">
                                ...
                                <div className="min-w-0">
                                    ...
                                    {r.posted_by?.handle ? (
                                        <a
                                            ...
                                            target="_blank"
                                            rel="noopener noreferrer"
                                            className="text-violet-600 dark:text-violet-400 hover:underline font-mono text-[11px] truncate block"
                                        >
                                ...
                                <div className="min-w-0 flex-1">
                                    {r.post_link ? (
                                        <a
                                            ...
                                            target="_blank"
                                            rel="noopener noreferrer"
                                            className="font-medium text-violet-600 dark:text-violet-400 hover:underline truncate block text-[11px] flex items-center gap-1"
                                        >
                ...
                <div className="rounded-2xl border border-border bg-card p-5 shadow-xs flex flex-col items-center justify-center text-center">
                    ...
                    <p className="text-[11px] font-medium text-muted-foreground mt-3 max-w-[180px]">
                        Scan via smartphone camera to view live social media thread
                    </p>
                </div>
            </div>

            {/* 3. SUGGESTION DESCRIPTION & REMARKS */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="rounded-2xl border border-border bg-card p-5 shadow-xs space-y-2">
                    ...
                    <div className="p-3.5 rounded-xl bg-muted/30 border border-border/50 text-xs leading-relaxed text-foreground whitespace-pre-wrap">
                        {r.post_description || 'No suggestion text recorded.'}
                    </div>
                </div>
                ...
                <div className="rounded-2xl border border-border bg-card p-5 shadow-xs space-y-2">
                    ...
                    <div className="p-3.5 rounded-xl bg-muted/30 border border-border/50 text-xs leading-relaxed text-foreground whitespace-pre-wrap">
                        {r.remarks || 'No internal remarks or action details provided.'}
                    </div>
                </div>
            </div>
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
                        {mediaUrls.map((url, i) => (
                            <button
                                ...
                                className="group relative aspect-video rounded-xl border border-border overflow-hidden hover:border-violet-500 transition-all bg-muted/40 cursor-pointer text-left"
                            >
                                {isVideo(url) ? (
            ...
            <div className="rounded-2xl border border-border bg-card p-4 shadow-xs flex flex-wrap items-center justify-between gap-3">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <p className="text-xs font-bold text-foreground">Share Suggestion via WhatsApp</p>
...
export const SuggestionReports = ({ openReportCode = '', onReportCodeHandled, suppressTable = false, onDetailClose }) => {
    ...
    const SortIcon = ({ column }) => (
        <ArrowUpDown className={cn(
            ...
            sortConfig.key === column ? "opacity-100 text-violet-600" : "opacity-30"
        )} />
    );
                    ...
                    {[
                        {
                            ...
                            activeClass: 'ring-2 ring-violet-500 border-violet-500 shadow-md shadow-violet-500/10 bg-violet-500/[0.08]',
                            badge: 'All Logs',
                            dot: 'bg-violet-500'
                        },
                        {
                ...
                <div className="flex flex-wrap items-center justify-between gap-2.5 px-3.5 py-2.5 border-b border-border bg-card/80 backdrop-blur-sm rounded-t-xl">
                    <div className="flex flex-wrap items-center gap-2">
                        ...
                        <div className="flex items-center gap-1.5">
                            <Select value={quickRange} onValueChange={(v) => { setQuickRange(v); setPage(1); }}>
                                <SelectTrigger className="h-8 w-[125px] text-xs bg-background font-medium rounded-lg shadow-xs border-border/80 hover:border-violet-500/50 transition-colors">
                        ...
                        <Select value={categoryFilter} onValueChange={(v) => { setCategoryFilter(v); setPage(1); }}>
                            <SelectTrigger className="h-8 w-[138px] text-xs bg-background font-medium rounded-lg shadow-xs border-border/80 hover:border-violet-500/50 transition-colors">
                        ...
                        <Select value={platform} onValueChange={(v) => { setPlatform(v); setPage(1); }}>
                            <SelectTrigger className="h-8 w-[130px] text-xs bg-background font-medium rounded-lg shadow-xs border-border/80 hover:border-violet-500/50 transition-colors">
                    ...
                    <div className="flex items-center gap-2 ml-auto w-full sm:w-auto">
                        ...
                        <Button
                            ...
                            className="h-8 w-8 p-0 shrink-0 rounded-lg bg-background shadow-xs hover:border-violet-500/40"
                        ...
                        <Button
                            ...
                            className="h-8 gap-1.5 text-xs font-bold px-3.5 bg-gradient-to-r from-violet-600 to-purple-600 hover:from-violet-700 hover:to-purple-700 text-white rounded-lg shadow-sm shadow-violet-600/25 transition-all"
                        >
                ...
                <CardContent className="p-0">
                    {loading ? (
                        <div className="flex flex-col items-center justify-center py-16">
                            <Loader2 className="h-7 w-7 animate-spin text-violet-600 mb-3" />
                            <p className="text-sm font-medium text-muted-foreground">Loading suggestion reports…</p>
                        </div>
                    ) : reports.length === 0 ? (
                        <div className="text-center py-16 px-4">
                            ...
                            <p className="text-sm font-bold text-foreground">No Suggestion Reports Found</p>
                            <p className="text-xs text-muted-foreground mt-1 max-w-sm mx-auto">
                                {hasActiveFilters
                                    ? 'Try adjusting your filters or date range to see matching suggestions.'
                                    : 'Create new suggestion reports from post cards in the grievance feed.'}
                            </p>
                            {hasActiveFilters && (
                                <Button
                                    variant="outline"
                                    ...
                                    <thead className="bg-muted/50 dark:bg-muted/30 backdrop-blur sticky top-0 z-20 border-b border-border">
                                        <tr>
                                            {[
                                                ...
                                                { key: 'description', label: 'Suggestion Description', className: 'min-w-[220px] max-w-sm' },
                                        ...
                                        {reports.map((r, idx) => {
                                            ...
                                            return (
                                                ...
                                                >
                                                    ...
                                                    <td className="py-2.5 px-3 align-top whitespace-nowrap">
                                                        <div className="flex items-center gap-1.5">
                                                            <span className="font-mono font-bold text-xs text-violet-700 dark:text-violet-300 bg-violet-50 dark:bg-violet-950/50 px-2 py-0.5 rounded-md border border-violet-200 dark:border-violet-800">
                                                                {r.unique_code}
                                                            </span>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td className="py-2.5 px-3 align-top">
                                                        <div className="flex items-start gap-2 max-w-[160px]">
                                                            ...
                                                            <div className="min-w-0">
                                                                ...
                                                                {r.posted_by?.handle && (
                                                                    <span className="text-[10px] text-violet-600 dark:text-violet-400 font-mono truncate block">
                                                                        @{r.posted_by.handle.replace('@', '')}
                                                                    </span>
                                                                )}
                                                            </div>
                                                    ...
                                                    <td className="py-2.5 px-3 align-top text-center" onClick={(e) => e.stopPropagation()}>
                                                        {r.post_link ? (
                                                            <a
                                                                ...
                                                                target="_blank"
                                                                rel="noopener noreferrer"
                                                                className="h-7 w-7 inline-flex items-center justify-center rounded-lg bg-violet-50 dark:bg-violet-950/40 text-violet-600 dark:text-violet-400 hover:bg-violet-100 hover:text-violet-700 transition-colors"
                                                    ...
                                                    {/* Category */}
                                                    <td className="py-2.5 px-3 align-top whitespace-nowrap">
                                                        <Badge variant="outline" className="text-[10px] font-bold border-violet-500/30 text-violet-600 dark:text-violet-400 bg-violet-500/10">
                                                            {r.category || 'Others'}
                                                        </Badge>
                                                    </td>
                                                        ...
                                                        <Tooltip>
                                                            <TooltipTrigger asChild>
                                                                <Button
                                                                    ...
                                                                    size="sm"
                                                                    onClick={() => setSelectedReport(r)}
                                                                    className="h-7 w-7 p-0 rounded-lg hover:bg-violet-100 dark:hover:bg-violet-950/50 text-violet-600 dark:text-violet-400"
                                                                >
                                                                    <Eye className="h-4 w-4" />
                                                                </Button>
                            </TooltipTrigger>
                                                            <TooltipContent side="left"><p className="text-xs">Open Suggestion Dossier</p></TooltipContent>
                                                        </Tooltip>
                                                    </td>
                                                </tr>
                                            );
                                ...
                                >
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="text-xs font-bold text-muted-foreground uppercase tracking-wider">
                                            Suggestion Case Inspector
                                        </span>
                                        <Badge variant="outline" className="text-[10px] font-mono font-bold text-violet-600 dark:text-violet-400 bg-violet-500/10 border-violet-500/30">
