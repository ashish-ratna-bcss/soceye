...
/*                       CRITICISM POPUP                          */
/* ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ */
export const CriticismPopup = ({ grievance, onClose, onReportCreated, userName = '' }) => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            onReportCreated?.(report, grievance?.id);
    ...
    const handleShare = async (contact) => {
        ...
        try {
            ...
            if (reportId) {
                const shareRes = await api.put(`/criticism/reports/${reportId}/share`, {
                ...
                if (shareRes?.data) {
                    onReportCreated?.(shareRes.data, grievance?.id);
                }
            }
    ...
    /* ━━━━━ RENDER ━━━━━ */
    const stepMeta = {
        compose: { subtitle: 'Step 1 of 3 — Write the message for this criticism report' },
        contacts: { subtitle: 'Step 2 of 3 — Choose a contact and share on WhatsApp' },
        done: { subtitle: 'Step 3 of 3 — Criticism report finished' },
    };

    return (
        <ReportPopupShell
            theme="criticism"
            title="Create Criticism Report"
                            ...
                            <ScrollArea className="flex-1 p-4">
                                <div className="h-full min-h-0 flex flex-col gap-4">
                                    <div className="rounded-lg border border-border bg-muted/30 px-3 py-2 text-xs text-muted-foreground">
                                        This creates a <strong className="text-foreground">Criticism</strong> report from the social post,
                                    ...
                                    <div className="shrink-0">
                                        ...
                                        <select
                                            ...
                                            className="w-full h-10 px-3 rounded-md border border-border bg-background text-sm outline-none focus:ring-2 focus:ring-rose-300"
                                        >
                        ...
                        <div className="flex flex-col h-full">
                            <div className="shrink-0 p-3 border-b bg-muted/30">
                                <div className="flex items-center justify-between mb-2">
                                    <h3 className="text-sm font-semibold text-foreground">Who should receive this on WhatsApp?</h3>
                                    <Button
                                        variant="outline"
                                        size="sm"
