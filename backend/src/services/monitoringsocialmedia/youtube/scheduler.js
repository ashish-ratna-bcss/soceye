...
const tick = async () => {
  ...
  try {
    ...
    console.error('[monitoringsocialmedia/youtube] scheduler tick:', error.message);
  } finally {
    ticking = false;
  }
};
...
const startScheduler = () => {
  if (timer) return;
  console.log('[monitoringsocialmedia/youtube] scheduler started');
