// X / Twitter Blugate gateway base URL.
// Prefer:
...
// services/blugate/x/blugate.x.env.js (credentials come from env here —
// see ../blugate.http.js authFromEnv() — not a Postgres platforms table).
